...
char LoggedInStudentID[10] = ""; // Store the logged-in Student ID
...
/*void Menu()
{
    ...
    printf("\t\t[2] Record Academic Performance\n");
    printf("\t\t[3] Update Academic Performance\n");
    printf("\t\t[4] Show Academic Performance\n");
    printf("\t\t[5] Show All students.\n");
    printf("\t\t[6] Search A student.\n");
    printf("\t\t[7] Edit A student.\n");
    printf("\t\t[8] Delete A student.\n");
    printf("\t\t[9] Delete All students.\n");
    printf("\t\t[10] Clear The window.\n");
    printf("\t\t[11] About This Project.\n");
...
void LoginStudent() {
    ...
    for (int i = 0; i < TotalStudents; i++) {
        if (strcmp(Students[i].Email, enteredEmail) == 0 && strcmp(Students[i].ID, enteredID) == 0) {
            // If found, set the logged-in student's ID
    ...
    if (!found) {
        ...
        Sleep(1500);  // wait for 1.5 seconds before allowing another attempt
    }
}
